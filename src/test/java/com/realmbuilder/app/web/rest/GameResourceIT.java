...
class GameResourceIT {
    ...
    public static Game createEntity(EntityManager em) {
        Game game = new Game().name(DEFAULT_NAME).subName(DEFAULT_SUB_NAME).description(DEFAULT_DESCRIPTION);
        return game;
    }
    ...
    public static Game createUpdatedEntity(EntityManager em) {
        Game game = new Game().name(UPDATED_NAME).subName(UPDATED_SUB_NAME).description(UPDATED_DESCRIPTION);
        return game;
    }
    ...
    void putExistingGame() throws Exception {
        ...
        updatedGame.name(UPDATED_NAME).subName(UPDATED_SUB_NAME).description(UPDATED_DESCRIPTION);
    ...
    void fullUpdateGameWithPatch() throws Exception {
        ...
        partialUpdatedGame.name(UPDATED_NAME).subName(UPDATED_SUB_NAME).description(UPDATED_DESCRIPTION);
